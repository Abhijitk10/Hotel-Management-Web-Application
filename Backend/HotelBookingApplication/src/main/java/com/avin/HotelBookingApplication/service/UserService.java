...
public class UserService implements IUserService {
    ...
    public User registerUser(User user) {
     ...
     // Instead of: Role userRole = roleRepository.findByName("ROLE_USER").get();
        Role userRole = roleRepository.findByName("ROLE_USER")
                .orElseThrow(() -> new RuntimeException("Default role ROLE_USER not found in database. Please initialize roles."));
